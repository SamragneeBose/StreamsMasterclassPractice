...
public class Test06_GroupingBy {
    ...
    /**
     *  From the alphabet words, create a map
     *  whose keys are word length, and whose
     *  values are a list of those words.
     *  First start off with toMap().
     */
    @Test
